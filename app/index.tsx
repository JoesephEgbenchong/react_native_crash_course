...
export default function Index() {
  ...
  //call the global context for authentication rather than destructuring it
  const authContext = useGlobalContext();

  if(!authContext?.isLoading && authContext?.isLoggedIn) return  <Redirect href="/home" />
      ...
      <ScrollView contentContainerStyle={{ height: '100%' }}>
        <View className="w-full items-center justify-center min-h-[85vh] px-4">
          ...
          <Text className="text-sm font-pregular text-gray-100 mt-7 text-center">
            Where creativity meets innovation: Embark on a Journey of limitess exploration with Aora
          </Text>
